...
class vPFAE_Grav(torch.nn.Module):
    def __init__(self, in_channels, out_channels, space_dim):
        super(vPFAE_Grav, self).__init__()
        ...
        self.conv1 = GravNetConv(in_channels, layer1_out)
        self.conv2 = GravNetConv(layer1_out, layer2_out)
