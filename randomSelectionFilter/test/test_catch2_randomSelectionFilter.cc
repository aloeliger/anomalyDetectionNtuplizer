...
static constexpr auto s_tag = "[randomSelectionFilter]";

TEST_CASE("Standard checks of randomSelectionFilter", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDFilter("randomSelectionFilter"
